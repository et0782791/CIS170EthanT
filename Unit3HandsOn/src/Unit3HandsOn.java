...
public class Unit3HandsOn {
    ...
    public static void formatValue(int arraySize) {
        // Declare variable string width
        int  stringWidth = 14;

        int[] list = new int[arraySize];
        for (int i = 0; i < list.length; i++) {
            // adds random values to array list
        ...
        System.out.printf("%" + stringWidth + "d|", endTime);
        ...
        System.out.printf("%" + stringWidth + "d|", totalTime);
